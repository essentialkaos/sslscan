...
func (s *SSLLabsSuite) TestInfo(c *check.C) {
	...
	c.Assert(api.Info.EngineVersion, check.Equals, "2.0.5")
...
func (s *SSLLabsSuite) TestAnalyze(c *check.C) {
	...
	c.Assert(details.Suites, check.HasLen, 4)
	c.Assert(details.Suites[2].Protocol, check.Equals, 771)
	c.Assert(details.Suites[2].Preference, check.Equals, true)
	c.Assert(details.Suites[2].List[0].ID, check.Equals, 49200)
	c.Assert(details.Suites[2].List[0].Name, check.Equals, "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384")
	c.Assert(details.Suites[2].List[0].CipherStrength, check.Equals, 256)
	...
	c.Assert(details.Suites[2].List[0].NamedGroupID, check.Equals, 29)
	c.Assert(details.Suites[2].List[0].NamedGroupName, check.Equals, "x25519")
	c.Assert(details.Suites[2].List[0].Q, check.IsNil)
	c.Assert(details.Suites[2].List[4].ID, check.Equals, 49171)
	c.Assert(details.Suites[2].List[4].Name, check.Equals, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA")
	c.Assert(details.Suites[2].List[4].CipherStrength, check.Equals, 128)
	c.Assert(details.Suites[2].List[4].KxType, check.Equals, "ECDH")
	c.Assert(details.Suites[2].List[4].KxStrength, check.Equals, 3072)
	c.Assert(details.Suites[2].List[4].NamedGroupBits, check.Equals, 256)
	c.Assert(details.Suites[2].List[4].NamedGroupID, check.Equals, 29)
	c.Assert(details.Suites[2].List[4].NamedGroupName, check.Equals, "x25519")
	c.Assert(details.Suites[2].List[4].Q, check.NotNil)
