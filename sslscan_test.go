...
func (s *SSLLabsSuite) TestAnalyze(c *check.C) {
	...
	c.Assert(details.CertChains[0].ID, check.Equals, "a79e2617baa7cf849171eb4947fdb463f01e4ef50494445edde7a34633981ac8")
	c.Assert(details.CertChains[0].CertIDs, check.Not(check.HasLen), 0)
	c.Assert(details.CertChains[0].CertIDs[0], check.Equals, "728d2d3adf47af04d618483a89bb22db0ef3c0faf53e976bdf60fbb36cb6d3f1")
	c.Assert(details.CertChains[0].TrustPaths, check.Not(check.HasLen), 0)
	c.Assert(details.CertChains[0].TrustPaths[0].CertIDs[0], check.Equals, "728d2d3adf47af04d618483a89bb22db0ef3c0faf53e976bdf60fbb36cb6d3f1")
	...
	c.Assert(certs, check.HasLen, 13)
	c.Assert(certs[0].ID, check.Equals, "728d2d3adf47af04d618483a89bb22db0ef3c0faf53e976bdf60fbb36cb6d3f1")
	c.Assert(certs[0].Subject, check.Not(check.Equals), "")
	c.Assert(certs[0].SerialNumber, check.Equals, "1b03844fa08bb7d8e855da0830ce8b16")
	...
	c.Assert(certs[0].NotBefore, check.Equals, int64(1775606400000))
	c.Assert(certs[0].NotAfter, check.Equals, int64(1783382399000))
	c.Assert(certs[0].IssuerSubject, check.Equals, "CN=Sectigo Public Server Authentication CA DV R36, O=Sectigo Limited, C=GB")
	...
	c.Assert(certs[0].SHA1Hash, check.Equals, "b0e83fd582156f85efb9756d20ab58ea045bc664")
	c.Assert(certs[0].SHA256Hash, check.Equals, "728d2d3adf47af04d618483a89bb22db0ef3c0faf53e976bdf60fbb36cb6d3f1")
	c.Assert(certs[0].PINSHA256, check.Equals, "gO0zwqrLRnImiLIS7as15Eb2xYUrznJJngbchN4gSXY=")
